...
let arr=["дом","учавствовать","опасность","смятение","давать","идти","стыд","жертва","успех","раб","скрывать","сон","отвращение","приспособиться","вина","гомосексуальность","горе","мудрый","неприязнь","голый","внешность","позор","глупец","потерпеть неудачу","\xa0\xa0\xa0","босс","отступать","радость","скука","твердый","борьба за власть","тревога","измученный","угроза","сопротивляться","любить","жесткий","ребёнок","цикл","нарушать","ждать","сломать","чудесный","привычка","вцепиться","боль","игра","гнев","женщины","отец","отпускать","саморазрушение","устранять","ложь","надежда","незнакомцы","привлекательный","унижать","одинокий","соперник","недоумение","привязанность","\xa0\xa0\xa0","смешной","вытеснять","неправильный","начало","страх","запугивать","очарование","быть в долгу","смех","хвастаться","принуждение","изменять","знаток","брать","извинение","гниение","обязан","уродливый","мать","сомнение","ненависть","мужчины","атака","зависимый","эротический","поза","остановиться"],imgTable=document.querySelector(".img-table"),imgBtn=document.querySelector(".btn-img"),descBtn=document.querySelector(".btn-desc"),reBtn=document.querySelector(".btn-refresh");function getRandomIntInclusive(e,t){return e=Math.ceil(e),Math.floor(Math.random()*((t=Math.floor(t))-e+1)+e)}function handler(){document.querySelectorAll(".card-desc").forEach(e=>{e.onmousedown=function(t){t.preventDefault();var n=getCoords(e),l=t.pageX-n.left,r=t.pageY-n.top;function o(t){e.style.left=t.pageX-l+"px",e.style.top=t.pageY-r+"px"}e.style.position="absolute",imgTable.appendChild(e),o(t),e.style.zIndex=1e3,document.onmousemove=function(e){o(e)},e.onmouseup=function(){document.onmousemove=null,e.onmouseup=null}},e.ondragstart=function(){return!1}})}function getCoords(e){var t=e.getBoundingClientRect();return{top:t.top+scrollY,left:t.left+scrollX+124}}imgBtn.addEventListener("click",()=>{let e=document.createElement("div");e.classList.add("card-img");let t=document.createElement("span");t.style.cursor="pointer",t.style.zIndex=1e3,t.classList.add("card-desc"),t.textContent="",e.appendChild(t),imgTable.appendChild(e),e.style.backgroundImage="url(img/"+getRandomIntInclusive(1,88)+".webp)"}),descBtn.addEventListener("click",()=>{imgTable.querySelectorAll(".card-desc").forEach(e=>{""===e.innerText&&(e.innerText=arr[getRandomIntInclusive(0,89)])}),handler()}),reBtn.addEventListener("click",()=>{""===imgTable.innerHTML&&console.log("Nothing to clean"),imgTable.innerHTML=""});